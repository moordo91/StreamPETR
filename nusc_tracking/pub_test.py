...
def parse_args():
    ...
    parser.add_argument(
        "--checkpoint",help="the dir to checkpoint which the model read from", default='./results_nusc.json'
    )
...
def main():
    ...
    for i in range(size):
        ...
        outputs = tracker.step_centertrack(preds, time_lag, args.score_threshold)
        annos = []
